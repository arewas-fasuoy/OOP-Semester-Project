...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(141, 342);
			...
			this->textBox1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->textBox1->Location = System::Drawing::Point(16, 88);
			this->textBox1->Multiline = true;
			this->textBox1->Name = L"textBox1";
			this->textBox1->Size = System::Drawing::Size(266, 35);
			...
			this->textBox2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->textBox2->Location = System::Drawing::Point(16, 181);
			this->textBox2->Multiline = true;
			this->textBox2->Name = L"textBox2";
			this->textBox2->Size = System::Drawing::Size(266, 35);
			...
			this->textBox3->Size = System::Drawing::Size(266, 36);
			...
			this->label1->Text = L"ENTER CAR REGISTERATION NUMBER";
			// 
			// label2
			// 
			...
			this->label2->Text = L"ENTER DRIVER LISENCE NUMBER";
			// 
			// label3
			// 
			...
			this->label3->Size = System::Drawing::Size(352, 24);
			this->label3->TabIndex = 6;
			this->label3->Text = L"ENTER VEHICLE TYPE (heavy/light)";
			// 
			// MyForm
			// 
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		String^ reg_number = textBox1->Text;
		String^ license_number = textBox2->Text;
		String^ car_type = textBox3->Text;

		msclr::interop::marshal_context context;
		std::string regNumber = context.marshal_as<std::string>(reg_number);
		std::string LNumber = context.marshal_as<std::string>(license_number);
		std::string Type = context.marshal_as<std::string>(car_type);
		this->Hide();
		MyForm1^ form1 = gcnew MyForm1(regNumber, LNumber, Type);
		form1->Show();
